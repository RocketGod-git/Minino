...
#define THREAD_CHANNEL           CONFIG_OPTHREAD_CHANNEL
#define THREAD_PANID             CONFIG_OPTHREAD_PANID
#define THREAD_NETWORK_NAME      CONFIG_OPTHREAD_NETWORK_NAME
#define THREAD_EXTPANID          CONFIG_OPTHREAD_EXTPANID
#define THREAD_MESH_LOCAL_PREFIX CONFIG_OPTHREAD_MESH_LOCAL_PREFIX
#define THREAD_NETWORK_MASTERKEY CONFIG_OPTHREAD_NETWORK_MASTERKEY
#define THREAD_NETWORK_PSKC      CONFIG_OPTHREAD_NETWORK_PSKC
